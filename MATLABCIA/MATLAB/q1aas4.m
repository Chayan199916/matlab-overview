%q1aas4.m : Write a program in MATLAB to split a RGB image to 3 equal parts 
%along x-axis .
%Change the color of middle portion to Gray scale and the bottom portion
...
y1(1:r,1:c1,1:d)=x(1:r,1:c1,1:d); % 1/3rd portion of image
y2(1:r,1:c1,1:d)=x(1:r,c1+1:2*c1,1:d); % 2nd 1/3rd portion of image
y3(1:r,1:c2,1:d)=x(1:r,2*c1+1:c,1:d); % last 1/3rd portion of image
