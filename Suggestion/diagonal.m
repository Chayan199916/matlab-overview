...
for i=1:r
    for j=1:p
        z(i,j,1:d)=.2989*x(i,j,1)+.587*x(i,j,2)+.114*x(i,j,3);
    end
    p=p+1;
    if p>c
        break;
...
z(1:r,1:c,1)=z(1:r,1:c,1);
z(1:r,1:c,2)=z(1:r,1:c,1);
z(1:r,1:c,3)=z(1:r,1:c,1);
for i=1:r
    for j=1:c
        if z(i,j,1)>=127
            b(i,j,1)=255;
...
z(1:r,1:c,1)=b(1:r,1:c,1);
z(1:r,1:c,2)=b(1:r,1:c,1);
z(1:r,1:c,3)=b(1:r,1:c,1);
p=1;
for i=1:r
    for j=p:c
        x(i,j,1:d)=y(i,j,1:d);
